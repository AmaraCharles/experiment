(function () {
    ...
    function buildExtendedEditorButton(obj) {
        ...
        var block = buttWidg.get('render');
        var widg = false;
        //__msg.log(block, blockName, container, widg)
            ...
            widg.after('render', function (e) {
                ...
                setTimeout(function () {
                    ...
                    if (block && block._node && !block._extendedEditActive && !block.one('.extended-editor-button') && !block.one('.custom-table-block')) {
                        ...
                        __msg.log(block, widg, model);
                        widg.after('focusedChange', function (e) {
                            __msg.log('FocusedChange', e);
                            if (widg.ext_editor) {
                                if (e.newVal) {
                        ...
                        var extended_button = context.Y.Node.create('<div class="extended-editor-button" title="Extended Edit"><button data-action="extendedEdit">Extended Edit</button></div>');
                        var insert_point = block;//block.one('.sqs-block-editor-button-container')
                        block && block.addClass('extend-edit-mount')
                        insert_point && insert_point.append(extended_button);
